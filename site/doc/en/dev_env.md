...
Developers should use the environment available for [download](https://bitbucket.org/olemis/brython/downloads) : choose the zip file starting with "Brython_site_mirror" and unzip it in a directory (we call it the Brython directory in the next paragraphs)
